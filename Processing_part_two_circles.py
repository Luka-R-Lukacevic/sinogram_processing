...
for j in range(30):
    twocircles = CT_Object(np.zeros([128,128]))
    twocircles.add_circ_im(0.5,0.5,0.2,1)
    twocircles.add_circ_im(-0.5,-0.5,0.2,1)
    ground_sinogram = twocircles.sinogram.copy()
    ...
    twocircles.plot_center()
    pertubated_sinogram = twocircles.sinogram.copy()
    
    
    twocircles.plot_sin()
    twocircles.plot_rec()
    
    twocircles.rec_sin("poly","orthogonal",1)
    twocircles.rec_sin("poly","orthogonal",1)
    twocircles.rec_sin("poly","orthogonal",2)
    twocircles.rec_sin("poly","orthogonal",1)
    twocircles.rec_sin("poly","orthogonal",2)
    twocircles.rec_sin("poly","orthogonal",1)
    twocircles.rec_sin("poly","orthogonal",2)
    
    reconstructed_sinogram = twocircles.sinogram.copy()
